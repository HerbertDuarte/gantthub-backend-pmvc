...
-- AlterTable
ALTER TABLE "marcos" ADD COLUMN     "createdAt" TIMESTAMPTZ(3) NOT NULL DEFAULT CURRENT_TIMESTAMP;

-- AlterTable
ALTER TABLE "tarefas" ADD COLUMN     "tarefaPaiId" TEXT;
...
CREATE TABLE "usuarios_setores" (
    ...
    "setorerId" TEXT NOT NULL,
    "createdAt" TIMESTAMPTZ(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "usuarios_setores_pkey" PRIMARY KEY ("usuarioId","setorerId")
);
...
-- AddForeignKey
ALTER TABLE "setores" ADD CONSTRAINT "setores_setorPaiId_fkey" FOREIGN KEY ("setorPaiId") REFERENCES "setores"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "usuarios_setores" ADD CONSTRAINT "usuarios_setores_usuarioId_fkey" FOREIGN KEY ("usuarioId") REFERENCES "usuarios"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "usuarios_setores" ADD CONSTRAINT "usuarios_setores_setorerId_fkey" FOREIGN KEY ("setorerId") REFERENCES "setores"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

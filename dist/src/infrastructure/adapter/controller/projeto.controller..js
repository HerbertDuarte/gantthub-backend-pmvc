...
let ProjetoController = class ProjetoController {
    constructor(projetoPrismaRepository) {
        this.projetoPrismaRepository = projetoPrismaRepository;
    }
    async getAll() {
...
], ProjetoController.prototype, "getAll", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], ProjetoController.prototype, "getOne", null);
ProjetoController = __decorate([
    (0, common_1.Controller)('projeto'),
    __metadata("design:paramtypes", [projeto_prisma_repository_1.ProjetoPrismaRepository])
], ProjetoController);

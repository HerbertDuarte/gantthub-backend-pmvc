...
let TarefaController = class TarefaController {
    constructor(tarefaPrismaRepository) {
        this.tarefaPrismaRepository = tarefaPrismaRepository;
    }
    getAll(body) {
...
], TarefaController.prototype, "getAll", null);
__decorate([
    (0, common_1.Patch)(':id'),
    ...
    __metadata("design:returntype", void 0)
], TarefaController.prototype, "updateDescription", null);
__decorate([
...
TarefaController = __decorate([
    ...
    __metadata("design:paramtypes", [tarefa_prisma_repository_1.TarefaPrismaRepository])
], TarefaController);
